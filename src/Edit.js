...
const Edit = () => {
    ...
    const[category,categorychange]=useState(true);
    ...
    const handlesubmit=(e)=>{
      e.preventDefault();
      const empdata={id,title,brand,price,category};
                        ...
                        <div className="card-body">
                            ...
                            <div className="row">
                                ...
                                <div className="col-lg-12">
                                    ...
                                    <input checked={category} onChange={e=>categorychange(e.target.checked)} type="checkbox" className="form-check-input"></input>
